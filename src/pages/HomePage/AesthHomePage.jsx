...
function AesthHomePage() {
  ...
  return (
    <div className="HomePage">
      <div className="Offer">
        <h1 className="Slogan">
          Utilize The power of AI to elevate and Grow Your{' '}
          <span>
            Aesthetics <br /> Medicine, Dermatology
          </span>{' '}
          & <span>Plastic Surgery Practice</span>
        </h1>
        <p>
      ...
      <div className="Promotion Section">
        <img className="Phone" src="./img/aesth-phone.png" alt="Phone"></img>
